...
export function registerHandlers(deps: { catalogs: CatalogRepository; erpStore: ErpConfigStore; erpExecutor: ErpReadOnlyExecutor; erpProvider: ErpProductProvider; erpConnection: ErpConnection; media: MediaService; qr: QrService; pdf: PdfService; trustedIds: Set<number> }): void {
  ...
  on('erp:getManufacturers', () => [])
  on('erp:getCategories', () => [])
